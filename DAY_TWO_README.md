...
- Adding comments
  ...
  X Pass down the comments through each post to the CommentSection component. 
  X Be sure that you set the incoming `comments` props data on the state of the CommentSection component.
